...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(info.matches("new")){
            ...
            Bitmap selectImage= BitmapFactory.decodeResource(getApplicationContext().getResources(),R.drawable.galery);
            ...
            try {
                ...
                int imagIx=cursor.getColumnIndex("image");
                ...
                while (cursor.moveToNext()){
                    ...
                    byte[] bytes=cursor.getBlob(imagIx);
